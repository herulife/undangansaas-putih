...
function patchHtmlForLocalMode(html) {
  return html
    ...
    .replace(/\.\\\/assets\\\/audio\\\/241-teman-hidup-tulus-saxophone-cover-by-arie-suaka\.mp3/g, '.\\/assets\\/audio\\/campursari-ngebit-wedding-loop.wav')
    .replace(/\.\/assets\/audio\/241-teman-hidup-tulus-saxophone-cover-by-arie-suaka\.mp3/g, './assets/audio/campursari-ngebit-wedding-loop.wav')
...
async function main() {
  ...
  html = html.replace('</body>', '    <script src="./assets/js/local-overrides.js"></script>\n</body>');
