...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    var threshold = window.innerHeight / 2 + 33;
    var currentScroll = $(this).scrollTop() + threshold;
  ...
  $("#button-mode-read").on("click", function (event) {
    event.preventDefault();
...
autoScroll = (currentElement) => {
  interValScrolling = setIntervalAndExecute(function () {
    ...
    $("html, body").animate(
      { scrollTop: this.scrollY + rangeAutoScroll },
      speedAutoScroll,
      easingAutoScroll
    );
