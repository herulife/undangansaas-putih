	...
	s.extend(t.prototype, {
		...
		initSlideshow: function() {
			...
			for (i = 0; i < this.numSlides; i++) {
				...
				l.css({
					"background-image": "linear-gradient(360deg, #ffffff61, #ffffff78),url('" + this.settings.src[i] + "')"
				}).appendTo(n);
		...
		initSingle: function() {
			...
			n.css({
				"background-image": "linear-gradient(360deg, #ffffff61, #ffffff78),url('" + this.settings.src[0] + "')"
