...
const explicitNames = new Map([
  ...
  ['audio/javanese-gamelan-wedding-loop.wav', null],
  ['audio/gending-jawa-soft-wedding-loop.wav', null],
  ['audio/gending.mp3', 'audio/gending.mp3'],
  ...
  ['js/auto-scroll-controls.js', 'js/auto-scroll-controls.js'],
  ['js/deferred-vendors.js', 'js/deferred-vendors.js'],
  ...
  ['images/opening-poster-fast.jpg', 'images/opening-poster-fast.jpg'],
