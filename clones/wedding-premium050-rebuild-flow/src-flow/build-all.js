...
function patchHtml(html) {
  return html
    ...
    .replace(/<iframe[^>]+(?:youtube|google|maps)[\s\S]*?<\/iframe>/gi, '<div class="local-disabled-embed">Embed eksternal dimatikan untuk mode lokal.</div>')
    ...
    .replace(/href=(["'])https:\/\/maps\.google\.com\/[^"']+\1/gi, 'href="#" data-local-disabled="maps"')
